# BlinkIT_Grocery_Data_Analysis (Interactive Dashboard Creation Using MS Excel)
...
## Dataset Used 
- <a heref="https://github.com/Rakshith2552/Data_Analysis_Dashboard/blob/main/BlinkIt_project.xlsx">Dataset</a>
